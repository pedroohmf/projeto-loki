...
const Page = () => {
  ...
  return (
    <main className="h-screen lg:bg-cover cel:bg-cover cel:bg-center lg:bg-center bg-no-repeat bg-fixed " style={{backgroundImage: `url(https://image.tmdb.org/t/p/original${serie.data?.poster_path}`}}>
